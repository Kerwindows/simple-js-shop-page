...
$myUpdateChecker->setAuthentication('GVzfj_mGbMc3r1Xdpe19');
...
function css_columns_create_menu_entry() {
	...
	add_menu_page('CSS Class Names', 'Column Classes', 'edit_posts', 'main-page-css-columns', 'css_columns_show_main_page', $icon);
